...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://maciolek.github.io/";
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        assertTrue(checkTaskExistsInCrud(taskName));
    }
    ...
    public boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("dariuszmaciolek");
        driverTrello.findElement(By.id("password")).sendKeys("wygrana1");
    ...
    public void deleteTaskFromCrud(String taskName) throws InterruptedException {
